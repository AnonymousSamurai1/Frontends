...
function Supports() {
  ...
  const supportCat = [
    {
      image: Consult,
      description:
        'Expert technical support for farmers and distributors',
      name: "Technical support",
    },
    {
      image: Person2,
      description:
        'Clear and accurate product information and labelling',
  ...
  return (
    <Container>
      <div className="title">
        <Typed strings={["Supports and Resources"]} typeSpeed = {80} backSpeed={80} loop  className='typed1'/>
      </div>
        ...
        {supportCat.map((each, index) => (
          ...
          >
            <div className="support-image">
              ...
              <div className="support_detail-main">
